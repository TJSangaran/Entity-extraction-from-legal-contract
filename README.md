# Extractive Question and Answering using Large Language models for Information Extraction

## Table of contents

- [Extractive Question and Answering using Large Language models for Information Extraction](#extractive-question-and-answering-using-large-language-models-for-information-extraction)
  - [Table of contents](#table-of-contents)
  - [Overview](#overview)
  - [Publications](#publications)
      - [Research papers](#research-papers)
  - [Datasets](#datasets)
    - [Legal Contract datasets](#legal-contract-datasets)

## Overview

This project aims to automate the extraction of important clauses from contracts, reducing the time, cost, and effort required by legal professionals. Contract review is a labor-intensive process, with law firms spending about 50% of their time on this task. This project utilizes advanced machine learning models to identify and extract key clauses, focusing on salient obligations and red flags within lengthy legal documents.
...
* [Party Extraction from Legal Contract Using Contextualized Span Representations of Parties](https://aclanthology.org/2023.ranlp-1.116.pdf), 2023
* [CUAD: An Expert-Annotated NLP Dataset for Legal Contract Review](https://arxiv.org/pdf/2103.06268), 2021
* [Muppets straight out of Law School](https://arxiv.org/pdf/2010.02559), 2020
